...
from qdiff.utils import resume_cali_model, get_train_samples #,resume_cali_model_brecq_multi
from diffusers.pipelines.stable_diffusion.safety_checker import StableDiffusionSafetyChecker
from transformers import AutoFeatureExtractor
import torch.distributed as dist
# from multi_calib import resume_cali_model_brecq_multi
            ...
            if opt.resume:
                ...
                if not opt.resume_w:
                    ...
                    if(opt.weight_bit==4):
                        ...
                        mp.spawn(resume_cali_model_brecq_multi, nprocs=4, args=(sampler.model.model.diffusion_model, wq_params, aq_params, cali_data, True, "qdiff",opt,outpath,logger))
                        end = time.time()
                        print("brecq time: ", end-start)
                ...
                #     #del model
                #     model=model.cpu()
                #     sampler.model.model.diffusion_model=sampler.model.model.diffusion_model.cpu()
                # except:
                #     pass
                if opt.quant_act:
